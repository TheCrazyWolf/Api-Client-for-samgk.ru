...
{
    public IResultOutScheduleFromDate GetSchedule(DateTime date, IResultOutIdentity entity)
    {
        return GetScheduleAsync(date: date, type: ScheduleSearchType.Employee, entity.Id.ToString()).GetAwaiter()
            .GetResult();
    }

    public async Task<IResultOutScheduleFromDate> GetScheduleAsync(DateTime date, IResultOutIdentity entity)
    {
        return await GetScheduleAsync(date: date, type: ScheduleSearchType.Employee, entity.Id.ToString());
    }

    public IList<IResultOutScheduleFromDate> GetSchedule(DateTime startDate, DateTime endDate, IResultOutIdentity entity,
        int delay = 700)
    {
    ...
    public async Task<IList<IResultOutScheduleFromDate>> GetScheduleAsync(DateTime startDate, DateTime endDate,
    ...
    public IResultOutScheduleFromDate GetSchedule(DateTime date, IResultOutGroup entity)
    {
        return GetScheduleAsync(date: date, type: ScheduleSearchType.Group,
            entity.Id.ToString()).GetAwaiter().GetResult();
    }

    public async Task<IResultOutScheduleFromDate> GetScheduleAsync(DateTime date, IResultOutGroup entity)
    {
        return await GetScheduleAsync(date: date, type: ScheduleSearchType.Group,
            entity.Id.ToString());
    }

    public IList<IResultOutScheduleFromDate> GetSchedule(DateTime startDate, DateTime endDate, IResultOutGroup entity, int delay = 700)
    {
        return GetScheduleAsync(startDate: startDate, endDate: endDate, type: ScheduleSearchType.Group,
            entity.Id.ToString(), delay: delay).GetAwaiter().GetResult();
    }

    public async Task<IList<IResultOutScheduleFromDate>> GetScheduleAsync(DateTime startDate, DateTime endDate, IResultOutGroup entity,
        int delay = 700)
    {
    ...
    public IResultOutScheduleFromDate GetSchedule(DateTime date, IResultOutCab entity)
    {
        return GetScheduleAsync(date: date, type: ScheduleSearchType.Cab,
            entity.Adress).GetAwaiter().GetResult();
    }

    public async Task<IResultOutScheduleFromDate> GetScheduleAsync(DateTime date, IResultOutCab entity)
    {
        return await GetScheduleAsync(date: date, type: ScheduleSearchType.Cab,
            entity.Adress);
    }

    public IList<IResultOutScheduleFromDate> GetSchedule(DateTime startDate, DateTime endDate, IResultOutCab entity, int delay = 700)
    {
    ...
    public async Task<IList<IResultOutScheduleFromDate>> GetScheduleAsync(DateTime startDate, DateTime endDate, IResultOutCab entity,
        int delay = 700)
    {
    ...
    public IResultOutScheduleFromDate GetSchedule(DateTime date, ScheduleSearchType type, string id)
    {
        return GetScheduleAsync(date: date, type: type, id: id).GetAwaiter().GetResult();
    }

    public IResultOutScheduleFromDate GetSchedule(DateTime date, ScheduleSearchType type, long id)
    {
        return GetScheduleAsync(date: date, type: type, id: id.ToString()).GetAwaiter().GetResult();
    }

    public async Task<IResultOutScheduleFromDate> GetScheduleAsync(DateTime date, ScheduleSearchType type, long id)
    {
        return await GetScheduleAsync(date: date, type: type, id: id.ToString());
    }

    public IList<IResultOutScheduleFromDate> GetSchedule(DateTime startDate, DateTime endDate, ScheduleSearchType type,
    ...
    public IList<IResultOutScheduleFromDate> GetSchedule(DateTime startDate, DateTime endDate, ScheduleSearchType type, long id, int delay = 700)
    {
        return GetScheduleAsync(startDate: startDate, endDate: endDate, type: type, id: id, delay: delay).GetAwaiter()
            .GetResult();
    }

    public async Task<IResultOutScheduleFromDate> GetScheduleAsync(DateTime date, ScheduleSearchType type, string id)
    {
        ...
        try
        {
            ...
            {
                returenableResult.Lessons = returenableResult.Lessons.AddTalkImportantLesson(returenableResult.Date).SortByLessons();
            }
            ...
            {
                returenableResult.Lessons = returenableResult.Lessons.AddRussianMyHorizonTalk(returenableResult.Date).SortByLessons();
            }
    ...
    public async Task<IList<IResultOutScheduleFromDate>> GetScheduleAsync(DateTime startDate, DateTime endDate, ScheduleSearchType type, long id, int delay = 700)
    {
        return await GetScheduleAsync(startDate: startDate, endDate: endDate, type: type, id: id.ToString(), delay: delay);
    }

    public async Task<IList<IResultOutScheduleFromDate>> GetAllScheduleAsync(DateTime date, ScheduleSearchType type, int delay = 700)
    {
        await ConfiguringCache();
    ...
    public IList<IResultOutScheduleFromDate> GetAllSchedule(DateTime date, ScheduleSearchType type, int delay = 700)
    {
