...
foreach (var rasp in api.Sсhedule.GetSchedule(new DateOnly(2024, 09, 04), SсheduleSearchType.Cab, "5/512").Lessons)
{
...
foreach (var rasp in api.Sсhedule.GetSchedule(new DateOnly(2024, 09, 04),
             new DateOnly(2024, 09, 09), SсheduleSearchType.Cab, "5/512"))
{
